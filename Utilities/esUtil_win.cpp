   ...
   { 
      ...
      case WM_LBUTTONDOWN:
      {
          ...
          if (esContext && esContext->mouseFunc)
          {
              ...
              esContext->mouseFunc(esContext, MouseButtons::LEFT, MouseEvents::BTN_DOWN, x, y);
          }
      }
      break;
      ...
      case WM_LBUTTONUP:
      {
          ...
          if (esContext && esContext->mouseFunc)
          {
              int x = GET_X_LPARAM(lParam);
              int y = GET_Y_LPARAM(lParam);
              esContext->mouseFunc(esContext, MouseButtons::LEFT, MouseEvents::BTN_UP, x, y);
          }
      }
      break;
      ...
      case WM_RBUTTONDOWN:
      {
          ...
          if (esContext && esContext->mouseFunc)
          {
              int x = GET_X_LPARAM(lParam);
              int y = GET_Y_LPARAM(lParam);
              esContext->mouseFunc(esContext, MouseButtons::RIGHT, MouseEvents::BTN_DOWN, x, y);
          }
      }
      break;
      ...
      case WM_RBUTTONUP:
      {
          ...
          if (esContext && esContext->mouseFunc)
          {
              int x = GET_X_LPARAM(lParam);
              int y = GET_Y_LPARAM(lParam);
              esContext->mouseFunc(esContext, MouseButtons::RIGHT, MouseEvents::BTN_UP, x, y);
          }
      }
      break;
